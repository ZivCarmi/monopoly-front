...
const AlertDialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse justify-center sm:flex-row sm:space-x-reverse sm:space-x-2 px-4",
      className
    )}
    {...props}
  />
